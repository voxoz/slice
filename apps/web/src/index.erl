            ...
            #li{body=[
              case wf:user() of
                ...
                %  {ok, U} -> 
                    ...
                    url="/account", body=[
                    case User#user.avatar of undefined-> ""; Img-> #image{class=["img-circle", "img-polaroid"], image=iolist_to_binary([Img,"?sz=50&width=50&height=50"]), width= <<"50px">>, height= <<"50px">>} end,
                    case User#user.display_name of undefined -> []; N -> N end]} 
